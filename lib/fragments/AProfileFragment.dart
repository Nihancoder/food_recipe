...
import 'package:food_rcipe/screens/AFollowersScreen.dart';
                ...
                children: [
                  Positioned(
                    ...
                    child: ClipRRect(
                      ...
                      child: Image.asset('image/appetit/backgroundprofile.jpg',
                          width: MediaQuery.of(context).size.width, height: 220, fit: BoxFit.cover),
                    ),
                  ),
                  Positioned(
                  ...
                  Column(
                    ...
                    children: [
                      ClipRRect(
                        borderRadius: BorderRadius.circular(25),
                        child: Image.asset('image/appetit/topchef6.jpg', width: 120, height: 140, fit: BoxFit.cover),
                      ),
                      SizedBox(height: 8),
