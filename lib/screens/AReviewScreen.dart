                              ...
                              children: [
                                ...
                                Row(
                                  children: [
                                    ClipRRect(
                                      borderRadius: BorderRadius.circular(25),
                                      child: Image.asset(e.image.toString(), fit: BoxFit.cover, width: 35, height: 35),
                                    ),
                                    SizedBox(width: 8),
                                ...
                                Padding(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      ClipRRect(
                                          borderRadius: BorderRadius.circular(25),
                                          child: Image.asset(e.reviewpic.toString(),
                                              width: MediaQuery.of(context).size.width, height: 100, fit: BoxFit.cover)),
                                    ],
                                  ),
                                ),
                              ],
