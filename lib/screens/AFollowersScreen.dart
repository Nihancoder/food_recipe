              ...
              Row(
                ...
                children: [
                  ...
                  ClipRRect(
                    ...
                    child: Container(child: Icon(Icons.tune_outlined, color: Colors.white), color: Colors.orange, height: 50, width: 50),
                  ),
                ],
              ),
              SizedBox(
                    ...
                    .map((e) => Padding(
                          ...
                          child: Row(
                            children: [
                              ClipRRect(
                                borderRadius: BorderRadius.circular(25),
                                child: Image.asset(e.image.toString(), height: 50, width: 50, fit: BoxFit.cover),
                              ),
                              SizedBox(width: 4),
                              Expanded(
                                  child: Column(
                              ...
                              Align(
                                ...
                                child: ClipRRect(
                                  ...
                                  child: InkWell(
                                    child: Container(
                                        child: Icon(Icons.person_add_alt, color: Colors.grey),
                                        color: appStore.isDarkModeOn ? context.cardColor : appetitAppContainerColor,
                                        height: 50,
                                        width: 50),
                                  ),
