        ...
        child: Column(
          children: [
              ...
              children: [
                Row(
                  children: [
                    ClipRRect(
                      borderRadius: BorderRadius.circular(25),
                      child: Image.asset('image/appetit/topchef1.jpg', height: 40, width: 40, fit: BoxFit.cover),
                    ),
                    SizedBox(width: 8),
                    Column(
            ...
            ClipRRect(
              ...
              child: Stack(
                children: [
                  Image.asset('image/appetit/p1.jpg', width: MediaQuery.of(context).size.width, height: 250, fit: BoxFit.cover),
                  Positioned(
                    bottom: 16,
                    left: 16,
                    right: 16,
                  ...
                  children: [
                    Expanded(
                      ...
                      child: Column(
                        ...
                        mainAxisAlignment: MainAxisAlignment.center,
                        children: [
                          Image.asset('image/appetit/info1.png', height: 30, width: 30, fit: BoxFit.cover),
                          SizedBox(height: 4),
                    ...
                    Expanded(
                      ...
                      child: Column(
                        ...
                        mainAxisAlignment: MainAxisAlignment.center,
                        children: [
                          Image.asset('image/appetit/info2.png', height: 30, width: 30, fit: BoxFit.cover),
                          SizedBox(height: 4),
                    ...
                    Expanded(
                      ...
                      child: Column(
                        ...
                        mainAxisAlignment: MainAxisAlignment.center,
                        children: [
                          Image.asset('image/appetit/info3.png', height: 30, width: 50, fit: BoxFit.cover),
                          SizedBox(height: 4),
                          Text('Low', style: TextStyle(fontWeight: FontWeight.w600, color: context.iconColor)),
                ...
                children: [
                  ClipRRect(
                    ...
                    child: Container(
                      height: 60,
                      width: 60,
                      child: Image.asset('image/appetit/soup.jpg',
                          fit: BoxFit.cover, color: Colors.black.withOpacity(0.2), colorBlendMode: BlendMode.darken),
                    ),
                  ),
                  SizedBox(width: 8),
                  ClipRRect(
                    ...
                    child: Container(
                      height: 60,
                      width: 60,
                      child: Image.asset('image/appetit/category4.jpg',
                          fit: BoxFit.cover, color: Colors.black.withOpacity(0.2), colorBlendMode: BlendMode.darken),
                    ),
                  ),
                  SizedBox(width: 8),
                  ClipRRect(
                    ...
                    child: Container(
                      height: 60,
                      width: 60,
                      child: Image.asset('image/appetit/p1.jpg',
                          fit: BoxFit.cover, color: Colors.black.withOpacity(0.2), colorBlendMode: BlendMode.darken),
                    ),
                  ),
                  SizedBox(width: 8),
                  ClipRRect(
                    ...
                    child: Container(
                      height: 60,
                      width: 60,
                      child: Image.asset('image/appetit/p2.jpg',
                          fit: BoxFit.cover, color: Colors.black.withOpacity(0.2), colorBlendMode: BlendMode.darken),
                    ),
                  ),
                  SizedBox(width: 8),
                    ...
                    child: Stack(
                      children: [
                        Container(
                          height: 60,
                          width: 60,
                          child: Image.asset('image/appetit/p3.jpg',
                              fit: BoxFit.cover, color: Colors.black.withOpacity(0.2), colorBlendMode: BlendMode.darken),
                        ),
                        Container(
                          height: 60,
